...
class Point(Base):
    ...
    def __init__(self, country, region, city, post_code, address, name_TC, working_time, x, y, brand_name, holding_name, website, date_review):
